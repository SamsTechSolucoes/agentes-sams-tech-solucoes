...
Procedimentos operacionais **deste** repo. Sem secrets. Sem playbook de disparo em massa.
...
| [baixar-grok-bot.md](./baixar-grok-bot.md) | Instalar o app Grok Bot no Windows (não é o Cursor) |
...
Modelo para novos runbooks: quando usar, quem executa, pré-condições, passos, validar, rollback, nunca fazer.
